            ...
            if (_player.CanMove && _player.IsMoving)
            {
                switch (GetTheDirectionOfThePlayer())
                {
                    case (int)Direction.Up:
                        if(_context.CameraLoader.GetCamera.Position.Y > 10 && _context.CameraLoader.GetCamera.Position.Y < _context.MapLoad.GetMap.HeightInPixels && _context.Player.GCTPlayer.PositionY < _context.MapLoad.GetMap.HeightInPixels-(_context.Graphics.PreferredBackBufferHeight/2-(_context.Player._height/2))) _context.CameraLoader.GetCamera.Move(new Vector2(0, -_player.GetCharacterType.MoveSpeed));
                        return _player.Deplacement((int)Direction.Up);

                    case (int)Direction.Bottom:
                        if(_context.CameraLoader.GetCamera.Position.Y < _context.MapLoad.GetMap.HeightInPixels - 550 && _context.Player.GCTPlayer.PositionY > (_context.Graphics.PreferredBackBufferHeight/2- (_context.Player._height / 2))) _context.CameraLoader.GetCamera.Move(new Vector2(0, +_player.GetCharacterType.MoveSpeed));
                        return _player.Deplacement((int)Direction.Bottom);

                    case (int)Direction.Left:
                        if (_context.CameraLoader.GetCamera.Position.X > 10 && _context.CameraLoader.GetCamera.Position.X < _context.MapLoad.GetMap.WidthInPixels && _context.Player.GCTPlayer.PositionX < _context.MapLoad.GetMap.WidthInPixels- (_context.Graphics.PreferredBackBufferWidth / 2 - (_context.Player._width / 2))) _context.CameraLoader.GetCamera.Move(new Vector2(-_player.GetCharacterType.MoveSpeed, 0));
                        return _player.Deplacement((int)Direction.Left);

                    case (int)Direction.Right:
                        if(_context.CameraLoader.GetCamera.Position.X < _context.MapLoad.GetMap.WidthInPixels - 960 && _context.Player.GCTPlayer.PositionX > (_context.Graphics.PreferredBackBufferWidth / 2 - (_context.Player._width / 2))) _context.CameraLoader.GetCamera.Move(new Vector2(+_player.GetCharacterType.MoveSpeed, 0));
